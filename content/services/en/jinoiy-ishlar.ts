...
const content: ServiceContent = {
  ...
  practicalTips: [
    {
      title: "Use your right to an attorney immediately",
      text: "The law gives you the right to choose an attorney and to decline questioning until they arrive. Don't rush to waive this right.",
    },
    {
      title: "Don't sign anything without reading it first",
      text: "Read any document fully before signing and ask about anything unclear. Pressure to sign quickly is a warning sign.",
    },
    {
      title: "Don't over-explain",
      text: "Trying to \"make a good impression\" with excessive explanations often backfires. Briefly stating the facts is enough until your attorney arrives.",
    },
    {
      title: "Notify your family",
      text: "As soon as possible, let a family member or trusted person know — they can help you reach an attorney.",
    },
    {
      title: "Request copies of every document",
      text: "Try to get a copy of every document presented to you or that you sign — this matters for your defense later.",
    },
  ],
  howIHelp: [
  ...
  processSteps: [
    {
      ...
      text: "I listen to your situation, review any available documents, and give a preliminary legal assessment.",
    },
    {
      title: "Taking on the case",
      text: "We sign an engagement agreement, I formally join as defense counsel, and notify the investigative authorities.",
    },
    {
      title: "Defense during investigation",
      text: "I attend questioning and investigative actions and prepare the necessary motions and documents.",
    },
    {
      title: "Court representation",
      text: "Once the case reaches court, I fully represent the client at every hearing and file appeals where necessary.",
    },
  ],
  faq: [
    {
      question: "What should I do right after being arrested?",
      answer:
    ...
    {
      question: "When should I bring in an attorney — right away or during the investigation?",
      answer:
    ...
    {
      question: "Do I need an attorney if I'm innocent?",
      answer:
    ...
    {
      question: "Can pre-trial detention be challenged?",
      answer:
    ...
    {
      question: "How does your investigative background help my defense?",
      answer:
